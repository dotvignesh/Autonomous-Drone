...
class DroneTrainer:
    ...
    def setup_logging(self):
        ...
        self.log_file_path = os.path.join(self.log_dir, f"Train_Circuit_LOG_{self.run_id}.csv")
    ...
    def handle_timestep_updates(self):
        ...
        if self.time_step % self.print_freq == 0:
            ...
            if avg_reward > self.best_reward:
                ...
                best_model_path = os.path.join(self.checkpoint_base, "best_Circuit_ddpg.pth")
    ...
    def save_model(self):
        checkpoint_path = os.path.join(
            self.checkpoint_base, f"{self.i_episode}_checkpoint_Circuit.pth"
        )
...
if __name__ == "__main__":
    trainer = DroneTrainer(max_training_timesteps=int(1.25e6), tau=1e-3, gamma=0.99, lr_actor=0.00005, lr_critic=0.0005, noise_decay=0.9999, hidden_dim1=512, hidden_dim2=512, memory_size=int(1e6), batch_size=128)
    trainer.train()
