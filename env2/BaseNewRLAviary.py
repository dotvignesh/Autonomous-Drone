"""
Code from: https://github.com/eunjuyummy/autonomous-drone-flight-project/blob/Simulate_a_paper/gym_pybullet_drones/envs/single_agent_rl/FlyThruGateAviary.py
"""
...
class BaseNewRLAviary(BaseAviary):
